...
//        userToAdd.setRoles(asList("ROLE_USER"));
    ...
    //私有 login_flag
    //private String login_flag(String username,String password){
        //UsernamePasswordQuthenticationToken upToken = new UsernamePasswordAuthenticaiotnToken(username,password);
        //验证用户名 密码
        //final Authentication authentication = authenticationManager.authenticate(upToken);
        //SecurityContextHolder.getContext().setAuthentiction(Autehntication);
        //final userDetails userDetails =userDetailsService.loadUserByUsername(username);
        //final String token =jwtTokenUtil.generateToken(userDetails);
        //return token;
    }
